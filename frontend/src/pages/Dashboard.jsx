...
import FeedControlPanel, { useDeleteFeed } from 'Components/feeds/FeedControlPanel';
        ...
        <div className="dashboard">
            <section className="dashboard__section">
                <div className="dashboard__section-header">
                    ...
                    {editingFeed !== 'new' && (
                        <button className="btn btn--primary" onClick={() => setEditingFeed('new')}>
                            + Add Feed
                        </button>
                    )}
                </div>
            ...
            <section className="dashboard__section">
                <div className="dashboard__section-header">
                    ...
                    <Link to="/feeditems" className="dashboard__view-all">View all →</Link>
                </div>
